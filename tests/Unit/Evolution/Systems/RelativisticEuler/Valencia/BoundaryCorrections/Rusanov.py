...
def dg_package_data_tilde_d(tilde_d, tilde_tau, tilde_s, flux_tilde_d,
                            flux_tilde_tau, flux_tilde_s, lapse, shift,
                            spatial_metric, rest_mass_density,
                            specific_internal_energy, specific_enthalpy,
                            spatial_velocity, normal_covector, normal_vector,
                            mesh_velocity, normal_dot_mesh_velocity,
                            use_polytropic_fluid):
    return tilde_d


def dg_package_data_tilde_tau(tilde_d, tilde_tau, tilde_s, flux_tilde_d,
                              flux_tilde_tau, flux_tilde_s, lapse, shift,
                              spatial_metric, rest_mass_density,
                              specific_internal_energy, specific_enthalpy,
                              spatial_velocity, normal_covector, normal_vector,
...
def dg_package_data_tilde_s(tilde_d, tilde_tau, tilde_s, flux_tilde_d,
                            flux_tilde_tau, flux_tilde_s, lapse, shift,
                            spatial_metric, rest_mass_density,
                            specific_internal_energy, specific_enthalpy,
                            spatial_velocity, normal_covector, normal_vector,
...
def dg_package_data_normal_dot_flux_tilde_d(
        tilde_d, tilde_tau, tilde_s, flux_tilde_d, flux_tilde_tau,
        flux_tilde_s, lapse, shift, spatial_metric, rest_mass_density,
