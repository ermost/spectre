...
def dg_boundary_terms_mass_density(
        ...
        interior_energy_density, interior_normal_dot_flux_mass_density,
        interior_normal_dot_flux_momentum_density,
        interior_normal_dot_flux_energy_density, interior_abs_char_speed,
        exterior_mass_density, exterior_momentum_density,
        exterior_energy_density, exterior_normal_dot_flux_mass_density,
